...
from llama_user.ft.DeskTrainer import DeskTrainer
...
def run_sft(
    ...
    model = (tokenizer, model_args, finetuning_args, training_args.do_train)

    if getattr(model, "is_quantload_model_desk_verized", False) and not training_args.do_train:
